...
public class Main {
	...
	public static void main(String[] args) {
		...
		Location evry = new Location("EVRY",48.629_828, 2.441_781_999_999_9892);
		evry.display();
		Location paris = new Location("Paris",48.85661400000001,2.3522219000000177);
		paris.display();
		System.out.println(paris.distanceTo(evry)+" km");
		// creation de plusieurs location
		...
		// creation des voisins avec la fonction Setneighbors
		...
		// allocation d'une variable test de la classe Location
		Location [] test= new Location[5];
		// ajout de trois locations dans la liste
         test.length;
         test.add(paris);
         test.add(orleans);
         for ( Location ville:test)
        	 ville.display();
